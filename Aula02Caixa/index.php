...
<body>
    ...
    //EM ANÁLISE E MANUTENÇÃO
        ...
        if ($_POST["usuario"] == $usuario and $_POST["senha"] == $senha) //Se o usuario e senha forem compativeis com as informações da matriz.
            header("location: conta.php"); //Se as informações de login estiverem corretas, ao clicar no botão o usuário será levado a tela de conta. 
        else
        {
            echo "<script>alert('Email ou senha incorretos. Tente novamente.');</script>"; //Se as informações estiverem incorretas, irá aparecer esse alerta. Número de tentativas será reduzido a cada tentativa.            
        }
