<!--Objetivo do Código: Exibir os produtos em destaque na Home-->
<!--Status do Código: Em análise-->

<?php 
include '../model/model_connect.php'; //Conecta com o banco.
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail ">
                   <a href="produto_detalhes.php?id=<?php echo $row_produtos['id'] ?>">
                       <img src="view_img/<?php echo $row_produtos['imagem'] ?>" alt="" class="img-responsive img-rounded"> 
                   </a> 
                  <div class="caption text-right bg-danger"> 
                    ...
                    <p>
                        ...
                        <a href="view_produtoDetalhes.php?id=<?php echo $row_produtos['id']; ?>">
